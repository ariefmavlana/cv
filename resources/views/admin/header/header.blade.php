        ...
        <div class="header-content">
                    ...
                    <li class="menu-content ps-menu">
                        <a href="#">
                            <div class="message-image">
                                <img src="{{ asset('assets/admin/assets/images/avatar1.png') }}"
                        ...
                        <a href="#">
                            <div class="message-image">
                                <img src="{{ asset('assets/admin/assets/images/avatar2.png') }}"
                                    class="rounded-circle w-100" alt="user1">
                            </div>
            ...
            <div class="dropdown dropdown-menu-end">
                <a href="#" class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <img class="img-user" src="{{ asset('assets/admin/assets/images/avatar1.png') }}" alt="user"
                        srcset="">
                </a>
                    ...
                    <li class="menu-content ps-menu">
                        ...
                        <a href="#">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button class="description" style="background-color: transparent;border:none">
